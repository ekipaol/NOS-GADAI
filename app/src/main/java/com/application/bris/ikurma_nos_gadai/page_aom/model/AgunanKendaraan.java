...
public class AgunanKendaraan {
    ...
    @SerializedName("idPhotoKDBPKB")
    @Expose
    private Integer idPhotoKDBPKB;
    @SerializedName("idPhotoKDUtama")
    @Expose
    private Integer idPhotoKDUtama;
    @SerializedName("idPhotoKDInterior")
    @Expose
    private Integer idPhotoKDInterior;
    @SerializedName("idPhotoKDMesin")
    @Expose
    private Integer idPhotoKDMesin;
    ...
    public Integer getIdPhotoKDBPKB() {
        return idPhotoKDBPKB;
    }

    public Integer getIdPhotoKDUtama() {
        return idPhotoKDUtama;
    }

    public Integer getIdPhotoKDInterior() {
        return idPhotoKDInterior;
    }

    public Integer getIdPhotoKDMesin() {
        return idPhotoKDMesin;
    }
}
