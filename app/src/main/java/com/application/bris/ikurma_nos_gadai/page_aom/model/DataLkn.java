...
public class DataLkn {
    ...
    @SerializedName("ALAMAT_TEMPAT_KERJA_1")
    public String aLAMATTEMPATKERJA1;
    @SerializedName("INVENTORY")
    public String iNVENTORY;
    @SerializedName("STATUS_PERMOHONAN")
    public String sTATUSPERMOHONAN;
    @SerializedName("PROPINSI_TEMPAT_KERJA")
    public String pROPINSITEMPATKERJA;
    @SerializedName("ANGSURAN_ALL")
    public Long aNGSURANALL;
    ...
    @SerializedName("TOTAL_EKSPOSURE_BRIS")
    public Long tOTALEKSPOSUREBRIS;
    ...
    @SerializedName("RW_TEMPAT_KERJA")
    public String rWTEMPATKERJA;
    ...
    @SerializedName("RT_TEMPAT_KERJA")
    public String rTTEMPATKERJA;
    @SerializedName("LOKASI_USAHA")
    public String lOKASIUSAHA;
    @SerializedName("DOH_INVENTORY")
    public Long dOHINVENTORY;
    ...
    @SerializedName("KECAMATAN_TEMPAT_KERJA")
    public String kECAMATANTEMPATKERJA;
    @SerializedName("BELANJA_RT")
    public String bELANJART;
    @SerializedName("DOH_PIUTANG")
    public Long dOHPIUTANG;
    ...
    @SerializedName("KELURAHAN_TEMPAT_KERJA")
    public String kELURAHANTEMPATKERJA;
    @SerializedName("TELP_KANTOR")
    public String tELPKANTOR;
    ...
    public DataLkn(String jATUHTEMPOQARDH, Long pERPUTARANPIUTANG, String nAMAUSAHA, String gPM, String hARGASEWA, Long iDLKN2, String jENISTEMPATUSAHA, String pENGHASILANLAINNYA, String bIAYAPENDIDIKAN, String pENGELUARANUSAHA, String bIAYATELEPONRT, String tOTALPENGELUARANRT, String tOTALPENGHASILAN, String tOTALPEMBIAYAAN, String aLAMATTEMPATKERJA1, String iNVENTORY, String sTATUSPERMOHONAN, String pROPINSITEMPATKERJA, Long aNGSURANALL, String sTATUSTEMPATUSAHA, String pENDAPATANUSAHA, Long fIDAPLIKASI, String sISAPENGHASILAN, String lAMABEKERJA, String jENISANGSURAN, String jWKONSUMTIF, Long tOTALEKSPOSUREBRIS, String bIAYATRANSPORTASI, Long jARAKLOKASI, Long pERPUTARANPERSEDIAAN, String pEMBIAYAANKONSUMTIF, String bIAYATELEPONLISTRIK, String kEUNTUNGANUSAHA, String jWPRODUKTIF2, String rWTEMPATKERJA, String jENISUSAHA, String jWTAKEOVER, String uTANGDAGANG, Long pERPUTARANUTANG, String rTTEMPATKERJA, String lOKASIUSAHA, Long dOHINVENTORY, String mARGINEFEKTIFPRODUKTIF2, String aLAMATUSAHA, String mARGINEFEKTIFPRODUKTIF1, String rEKOMENDASIPUTUSAN, Long kEBUTUHANMODAL, String pEMBIAYAANPRODUKTIF2, Long dOHUTANG, String pEMBIAYAANPRODUKTIF1, String jWPRODUKTIF1, String kECAMATANTEMPATKERJA, String bELANJART, Long dOHPIUTANG, String aNGSURANEXISTING, String hARGAPOKOKPENJUALAN, String bIAYATRANSPORTASIRT, String bIDANGUSAHA, String pIUTANGDAGANG, String tELEPON, String kELURAHANTEMPATKERJA, String tELPKANTOR, String iNTERVALIRREGULAR, String pAJAK, String wINERACA, String pENGELUARANLAINNYA, String nAMAORANGDITEMUI, Long lAMAUSAHA, String tANGGALPENILAIAN, String pEMBIAYAANTAKEOVER, String mARGINEFEKTIFKONSUMTIF, String mARGINEFEKTIFTAKEOVER, String aSPEKPEMASARAN, String wINORMAL, String gAJIPEGAWAI, String pENGELUARANLAINNYART, String bIAYASEWARUMAHRT, String mARGINFLATBULAN, String hUBUNGAN, int fIDPHOTODEPAN, int fIDPHOTODALAM, int fIDPHOTOLINGKUNGAN) {
        ...
        this.pROPINSITEMPATKERJA = pROPINSITEMPATKERJA;
        this.aNGSURANALL = aNGSURANALL;
        ...
        this.tOTALEKSPOSUREBRIS = tOTALEKSPOSUREBRIS;
        ...
        this.kECAMATANTEMPATKERJA = kECAMATANTEMPATKERJA;
        ...
        this.kELURAHANTEMPATKERJA = kELURAHANTEMPATKERJA;
    ...
    public String getpROPINSITEMPATKERJA() {
        return pROPINSITEMPATKERJA;
    }

    public Long getaNGSURANALL() {
        return aNGSURANALL;
    }
    ...
    public Long gettOTALEKSPOSUREBRIS() {
        return tOTALEKSPOSUREBRIS;
    }
    ...
    public String getrWTEMPATKERJA() {
        return rWTEMPATKERJA;
    }
    ...
    public String getrTTEMPATKERJA() {
        return rTTEMPATKERJA;
    }
    ...
    public String getkECAMATANTEMPATKERJA() {
        return kECAMATANTEMPATKERJA;
    }
    ...
    public String getkELURAHANTEMPATKERJA() {
        return kELURAHANTEMPATKERJA;
    }
