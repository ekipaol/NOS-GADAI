...
//        req.setCif(81862);
        ...
        //pengecekan scoring khusus flpp
        if(idProgram.equalsIgnoreCase("222")){
            call = apiClientAdapter.getApiInterface().updateScoringFlpp(req);
        }
        else{
        ...
        call.enqueue(new Callback<ParseResponse>() {
            ...
            public void onResponse(Call<ParseResponse> call, Response<ParseResponse> response) {
                ...
                //pantekan
//                Toast.makeText(ScoringKprActivity.this, "id aplikasi masih hardcoded", Toast.LENGTH_SHORT).show();
