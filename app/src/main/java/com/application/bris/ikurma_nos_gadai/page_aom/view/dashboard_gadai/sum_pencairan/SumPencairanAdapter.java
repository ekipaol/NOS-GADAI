...
import com.application.bris.ikurma_nos_gadai.databinding.ItemListSumPencairanBinding;
...
public class SumPencairanAdapter extends RecyclerView.Adapter<SumPencairanAdapter.MenuViewHolder> {

    private List <SumPencairanGadai> data;
    private Context context;
    private ItemListSumPencairanBinding binding;
    private List <SumPencairanGadai> datafiltered;
    private AppPreferences appPreferences;

    public SumPencairanAdapter(Context context, List <SumPencairanGadai> mdata) {
    ...
    public MenuViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding = ItemListSumPencairanBinding.inflate(layoutInflater, parent, false);
        View view = binding.getRoot();
        appPreferences = new AppPreferences(context);
        return new SumPencairanAdapter.MenuViewHolder(view);
    }
...
//        if(datas.getTotalOutstanding() == 0.00){
//            holder.etTotalStanding.setText(datas.getTotalOutstanding().toString());
//        }else {
