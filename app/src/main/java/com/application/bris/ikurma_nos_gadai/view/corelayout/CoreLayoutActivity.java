package com.application.bris.ikurma_nos_gadai.view.corelayout;
...
import com.application.bris.ikurma_nos_gadai.view.corelayout.ranking.FragmentRanking;
...
import com.application.bris.ikurma_nos_gadai.database.model.ProductModel;
import com.application.bris.ikurma_nos_gadai.database.model.SektorEkonomiModel;
import com.application.bris.ikurma_nos_gadai.util.AppUtil;
import com.application.bris.ikurma_nos_gadai.util.BackStackFragment;
import com.application.bris.ikurma_nos_gadai.view.corelayout.home.FragmentHome;
import com.application.bris.ikurma_nos_gadai.view.corelayout.user.FragmentUser;
...
//                Toast.makeText(this, "Segera Tersedia", Toast.LENGTH_SHORT).show();
    ...
    private void loadKategSektorEkonomi(){
        Call<ParseResponse> call = apiClientAdapter.getApiInterface().getKategSektorEkonomii(EmptyRequest.INSTANCE);
        call.enqueue(new Callback<ParseResponse>() {
            @Override
            public void onResponse(Call<ParseResponse> call, Response<ParseResponse> response) {
                try {
