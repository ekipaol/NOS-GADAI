 ...
 *
 */
package com.application.bris.ikurma_nos_gadai.util.magiccrypt;

import android.os.Build;
import androidx.annotation.RequiresApi;

import com.application.bris.ikurma_nos_gadai.BuildConfig;
import com.application.bris.ikurma_nos_gadai.util.magiccrypt.lib.AESCrypt;
import com.application.bris.ikurma_nos_gadai.util.magiccrypt.lib.Crypt;
import com.application.bris.ikurma_nos_gadai.util.magiccrypt.lib.Crypt.CryptListener;
import com.application.bris.ikurma_nos_gadai.util.magiccrypt.lib.DESCrypt;
...
//     * @param key 傳入任意長度的密鑰字串
     ...
     * @throws IOException 當輸入輸出處理時發生問題，會拋出這個例外
     */
