...
import com.application.bris.ikurma_nos_gadai.util.NothingSelectedSpinnerAdapter;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class DialogSaveAgunanFlpp extends DialogFragment implements View.OnClickListener {
    ...
    public static DialogSaveAgunanFlpp display(FragmentManager fragmentManager, SaveAgunanListener addressListenerId) {
        addressListener = addressListenerId;
        DialogSaveAgunanFlpp dialogAddress = new DialogSaveAgunanFlpp();
    ...
    public void customToolbar(){
        ...
        tv_title.setText("Hasil Rekomendasi");
...
//        sp_typeaddress.setSelection(idMarketable);
//        sp_typeaddress.setEnabled(false);
