...
import com.application.bris.ikurma_nos_gadai.page_aom.listener.SlikListener;
import com.application.bris.ikurma_nos_gadai.page_aom.view.hotprospek.prescreening.model.ModelRemaksSlik;
import com.application.bris.ikurma_nos_gadai.page_aom.view.hotprospek.prescreening.remaksslik.RemaksSlikAdapater;
...
public class FragmentRemaksSlikPasanganKpr extends Fragment implements SlikListener{
    ...
    private String dataSlikPasangan,approved;
    private List<ModelRemaksSlik> data;
    private int REQUEST_CODE = 1;
    private RemaksSlikAdapater adp = null;

    public FragmentRemaksSlikPasanganKpr(){
    ...
    public void onSelectSlik(List<ModelRemaksSlik> listData, ModelRemaksSlik data, int position) {
        ...
        if(approved.equalsIgnoreCase("no")){
            ...
            Intent intent = new Intent(getContext(), RemaksSlikEditKprActivity.class);
