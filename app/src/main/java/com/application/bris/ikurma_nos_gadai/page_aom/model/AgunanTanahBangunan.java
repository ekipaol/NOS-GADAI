...
public class AgunanTanahBangunan {
    ...
    @Expose
    private String nLTanahBangunan;
    ...
    @Expose
    private String hargaBangunan2;
    @SerializedName("HargaBangunan1")
    @Expose
    private String hargaBangunan1;
    ...
    @Expose
    private String nPWTanahBangunan;
    ...
    @SerializedName("NPWBangunanBRIS")
    @Expose
    private String nPWBangunanBRIS;
    @SerializedName("LebarJalanDepan")
    @Expose
    private String lebarJalanDepan;
    ...
    @SerializedName("idPhotoTBbangunan")
    private Integer idPhotoTBbangunan;
    @SerializedName("idPhotoTButara")
    private Integer idPhotoTButara;
    @SerializedName("idPhotoTBselatan")
    private Integer idPhotoTBselatan;
    @SerializedName("idPhotoTBbarat")
    private Integer idPhotoTBbarat;
    @SerializedName("idPhotoTBtimur")
    private Integer idPhotoTBtimur;
    @SerializedName("idPhotoTBbpn")
    private Integer idPhotoTBbpn;
    ...
    @SerializedName("KetBangunan")
    @Expose
    private String KetBangunan;
    ...
    @Expose
    private String idRekomendasiPenilai;
    ...
    public String getIdRekomendasiPenilai() {
        return idRekomendasiPenilai;
    }

    public void setIdRekomendasiPenilai(String idRekomendasiPenilai) {
        this.idRekomendasiPenilai = idRekomendasiPenilai;
    }
    ...
    public String getKetBangunan() {
        return KetBangunan;
    }

    public void setKetBangunan(String ketBangunan) {
        KetBangunan = ketBangunan;
    }
    ...
    public String getnLTanahBangunan() {
    ...
    public String getHargaBangunan2() {
        return hargaBangunan2;
    }

    public String getHargaBangunan1() {
    ...
    public String getLuasBangunan2() {
    ...
    public String getLuasBangunan1() {
    ...
    public String getnPWTanahBangunan() {
    ...
    public String getnPWBangunanBRIS() {
        return nPWBangunanBRIS;
    }

    public String getLebarJalanDepan() {
    ...
    public Integer getIdPhotoTBbangunan() {
        return idPhotoTBbangunan;
    }

    public Integer getIdPhotoTButara() {
        return idPhotoTButara;
    }

    public Integer getIdPhotoTBselatan() {
        return idPhotoTBselatan;
    }

    public Integer getIdPhotoTBbarat() {
        return idPhotoTBbarat;
    }

    public Integer getIdPhotoTBtimur() {
        return idPhotoTBtimur;
    }

    public Integer getIdPhotoTBbpn() {
        return idPhotoTBbpn;
    }
    ...
    public void setAksesPencapaian(String aksesPencapaian) {
        this.aksesPencapaian = aksesPencapaian;
    }

    public void setJenisAgunanXBRL(String jenisAgunanXBRL) {
        this.jenisAgunanXBRL = jenisAgunanXBRL;
    }

    public void setHubPenghuniDgPemilik(String hubPenghuniDgPemilik) {
        this.hubPenghuniDgPemilik = hubPenghuniDgPemilik;
    }
    ...
    public void setFasilitasSosial(String fasilitasSosial) {
        this.fasilitasSosial = fasilitasSosial;
    }

    public void setHargaBangunan2(String hargaBangunan2) {
        this.hargaBangunan2 = hargaBangunan2;
    }

    public void setHargaBangunan1(String hargaBangunan1) {
        this.hargaBangunan1 = hargaBangunan1;
    }

    public void setPendapatKondisiJaminan(String pendapatKondisiJaminan) {
        this.pendapatKondisiJaminan = pendapatKondisiJaminan;
    }
    ...
    public void setPermukaanTanah(String permukaanTanah) {
        this.permukaanTanah = permukaanTanah;
    }
    ...
    public void setGarasiCarport(String garasiCarport) {
        this.garasiCarport = garasiCarport;
    }
    ...
    public void setPendapatHarga(String pendapatHarga) {
        this.pendapatHarga = pendapatHarga;
    }
    ...
    public void setBatasBaratTanah(String batasBaratTanah) {
        this.batasBaratTanah = batasBaratTanah;
    }
    ...
    public void setPerkembanganLingkungan(String perkembanganLingkungan) {
        this.perkembanganLingkungan = perkembanganLingkungan;
    }
    ...
    public void setDataPembanding1(String dataPembanding1) {
        this.dataPembanding1 = dataPembanding1;
    }

    public void setLuasBangunan2(String luasBangunan2) {
        this.luasBangunan2 = luasBangunan2;
    }

    public void setDataPembanding2(String dataPembanding2) {
        this.dataPembanding2 = dataPembanding2;
    }

    public void setLuasBangunan1(String luasBangunan1) {
        this.luasBangunan1 = luasBangunan1;
    }
    ...
    public void setnPWTanahBangunan(String nPWTanahBangunan) {
        this.nPWTanahBangunan = nPWTanahBangunan;
    }

    public void setBatasUtaraTanah(String batasUtaraTanah) {
        this.batasUtaraTanah = batasUtaraTanah;
    }
    ...
    public void setnPWBangunanBRIS(String nPWBangunanBRIS) {
        this.nPWBangunanBRIS = nPWBangunanBRIS;
    }

    public void setLebarJalanDepan(String lebarJalanDepan) {
        this.lebarJalanDepan = lebarJalanDepan;
    }

    public void setHargaMeterTanah(long hargaMeterTanah) {
        this.hargaMeterTanah = hargaMeterTanah;
    }

    public void setKondisiSekitar(String kondisiSekitar) {
        this.kondisiSekitar = kondisiSekitar;
    }
    ...
    public void setHubNasabahDgnPemegangHak(String hubNasabahDgnPemegangHak) {
        this.hubNasabahDgnPemegangHak = hubNasabahDgnPemegangHak;
    }
    ...
    public void setIdPhotoTBbangunan(Integer idPhotoTBbangunan) {
        this.idPhotoTBbangunan = idPhotoTBbangunan;
    }

    public void setIdPhotoTButara(Integer idPhotoTButara) {
        this.idPhotoTButara = idPhotoTButara;
    }

    public void setIdPhotoTBselatan(Integer idPhotoTBselatan) {
        this.idPhotoTBselatan = idPhotoTBselatan;
    }

    public void setIdPhotoTBbarat(Integer idPhotoTBbarat) {
        this.idPhotoTBbarat = idPhotoTBbarat;
    }

    public void setIdPhotoTBtimur(Integer idPhotoTBtimur) {
        this.idPhotoTBtimur = idPhotoTBtimur;
    }

    public void setIdPhotoTBbpn(Integer idPhotoTBbpn) {
        this.idPhotoTBbpn = idPhotoTBbpn;
    }
}
