package com.application.bris.ikurma_nos_gadai.page_aom.view.hotprospek.prescreening;
...
import com.application.bris.ikurma_nos_gadai.page_aom.listener.DownloadListener;
import com.application.bris.ikurma_nos_gadai.page_aom.model.DataPrescreening;
import com.application.bris.ikurma_nos_gadai.page_aom.view.hotprospek.HotprospekActivity;
import com.application.bris.ikurma_nos_gadai.page_aom.view.hotprospek.prescreening.remaksslik.RemaksSlikActivity;
import com.application.bris.ikurma_nos_gadai.util.AppUtil;
import com.application.bris.ikurma_nos_gadai.util.DownloadTask;
...
//        }
    ...
    private void loadPrescreening() {
        ...
        Call<ParseResponse> call = apiClientAdapter.getApiInterface().inquiryPrescreeningKonsumer(req);
...
//                                    btn_send.setEnabled(false);
    ...
    private void cekDHN() {
        loading.setVisibility(View.VISIBLE);
        Prescreening req = new Prescreening(idAplikasi);
        Call<ParseResponse> call = apiClientAdapter.getApiInterface().cekDHNKonsumer(req);
        call.enqueue(new Callback<ParseResponse>() {
            @Override
            public void onResponse(Call<ParseResponse> call, Response<ParseResponse> response) {
                loading.setVisibility(View.GONE);
    ...
    private void cekDukcapil() {
        loading.setVisibility(View.VISIBLE);
        Prescreening req = new Prescreening(idAplikasi);
        Call<ParseResponse> call = apiClientAdapter.getApiInterface().cekDukcapilKonsumer(req);
        call.enqueue(new Callback<ParseResponse>() {
            @Override
            public void onResponse(Call<ParseResponse> call, Response<ParseResponse> response) {
                loading.setVisibility(View.GONE);
    ...
    private void cekSlik() {
        ...
        Prescreening req = new Prescreening(idAplikasi);
        Call<ParseResponse> call = apiClientAdapter.getApiInterface().cekSlikKonsumer(req);
        call.enqueue(new Callback<ParseResponse>() {
            @Override
            public void onResponse(Call<ParseResponse> call, Response<ParseResponse> response) {
                loading.setVisibility(View.GONE);
...
//                                ll_info_gagal.setVisibility(View.VISIBLE);
    ...
    private void sendPrescreening() {
        loading.setVisibility(View.VISIBLE);
        Prescreening req = new Prescreening(idAplikasi);
        Call<ParseResponse> call = apiClientAdapter.getApiInterface().sendPrescreeningKonsumer(req);
        call.enqueue(new Callback<ParseResponse>() {
            @Override
            public void onResponse(Call<ParseResponse> call, Response<ParseResponse> response) {
                loading.setVisibility(View.GONE);
    ...
    private void downloadSlik(int id){
        ...
        if (id == 1){
            call = apiClientAdapter.getApiInterface().downloadSlikKonsumer(req);
        }
        else{
            call = apiClientAdapter.getApiInterface().downloadSlikPasanganKonsumer(req);
        }
        call.enqueue(new Callback<ParseResponse>() {
            @Override
            public void onResponse(Call<ParseResponse> call, Response<ParseResponse> response) {
