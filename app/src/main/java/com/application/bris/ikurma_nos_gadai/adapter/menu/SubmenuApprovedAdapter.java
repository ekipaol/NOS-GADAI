...
public class SubmenuApprovedAdapter extends RecyclerView.Adapter<SubmenuApprovedAdapter.MenuViewHolder> {
    ...
    public SubmenuApprovedAdapter(Context context, List<ListViewSubmenuHotprospek> menu, hotprospek mdata, MenuClickListener menuClickListener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SubmenuApprovedAdapter.MenuViewHolder holder, final int position) {
