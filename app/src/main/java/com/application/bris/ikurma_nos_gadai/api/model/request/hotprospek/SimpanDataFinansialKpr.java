...
public class SimpanDataFinansialKpr {
    ...
    @SerializedName("rumahKeBerapa")
    private String rumahKeBerapa;

    @SerializedName("jwQardh")
    private int jwQardh;

    @SerializedName("tujuanQardh")
    private String tujuanQardh;

    @SerializedName("jointIncome")
    private Double jointIncome;

    public Double getJointIncome() {
        return jointIncome;
    }

    public void setJointIncome(Double jointIncome) {
        this.jointIncome = jointIncome;
    }

    public int getJwQardh() {
        return jwQardh;
    }

    public void setJwQardh(int jwQardh) {
        this.jwQardh = jwQardh;
    }

    public String getTujuanQardh() {
        return tujuanQardh;
    }

    public void setTujuanQardh(String tujuanQardh) {
        this.tujuanQardh = tujuanQardh;
    }
