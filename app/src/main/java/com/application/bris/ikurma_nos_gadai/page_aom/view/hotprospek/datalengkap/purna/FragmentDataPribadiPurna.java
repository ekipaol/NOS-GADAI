package com.application.bris.ikurma_nos_gadai.page_aom.view.hotprospek.datalengkap.purna;
...
//    }
    ...
    public FragmentDataPribadiPurna(DataLengkap mdataLengkap, String maprroved) {
        dataLengkap = mdataLengkap;
        approved = maprroved;
    }
...
//        });
    ...
    private void setDynamicIcon(){
        AppUtil.dynamicIconLogoChange(getContext(),et_nik,tf_nik);
        AppUtil.dynamicIconLogoChange(getContext(),et_npwp,tf_npwp);
        AppUtil.dynamicIconLogoChange(getContext(),et_nama,tf_nama);
        AppUtil.dynamicIconLogoChange(getContext(),et_namaalias,tf_namaalias);
        AppUtil.dynamicIconLogoChange(getContext(),et_tempatlahir,tf_tempatlahir);
        AppUtil.dynamicIconLogoChange(getContext(),et_nomorhp,tf_nomorhp);
        AppUtil.dynamicIconLogoChange(getContext(),et_email,tf_email);
        AppUtil.dynamicIconLogoChange(getContext(),et_ketagama,tf_ketagama);
        AppUtil.dynamicIconLogoChange(getContext(),et_namaibukandung,tf_namaibukandung);
        AppUtil.dynamicIconLogoChange(getContext(),et_nikpasangan,tf_nikpasangan);
        AppUtil.dynamicIconLogoChange(getContext(),et_namakeluarga,tf_namakeluarga);
        AppUtil.dynamicIconLogoChange(getContext(),et_nomorhpkeluarga,tf_nomorhpkeluarga);
        AppUtil.dynamicIconLogoChange(getContext(),et_jumlahtanggungan,tf_jumlahtanggungan);
        AppUtil.dynamicIconLogoChange(getContext(),et_namapasangan,tf_namapasangan);
        AppUtil.dynamicIconLogoChange(getContext(),et_gelar,tf_gelar);
        AppUtil.dynamicIconLogoChange(getContext(),et_tanggallahir,tf_tanggallahir);
        AppUtil.dynamicIconLogoChange(getContext(),et_jeniskelamin,tf_jeniskelamin);
        AppUtil.dynamicIconLogoChange(getContext(),et_tipependapatan,tf_tipependapatan);
        AppUtil.dynamicIconLogoChange(getContext(),et_statusnikah,tf_statusnikah);
        AppUtil.dynamicIconLogoChange(getContext(),et_tanggallahirpasangan,tf_tanggallahirpasangan);

        AppUtil.dynamicIconLogoChange(getContext(),et_referensi,tf_referensi);
        AppUtil.dynamicIconLogoChange(getContext(),et_agama,tf_agama);
        AppUtil.dynamicIconLogoChange(getContext(),et_gelar,tf_gelar);
    ...
    private void setDynamicIconDropDown(){
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_tanggallahir,et_tanggallahir);
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_expirednik,et_expirednik);
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_agama,et_agama);
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_statusnikah,et_statusnikah);
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_tanggallahirpasangan,et_tanggallahirpasangan);
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_tipependapatan,et_tipependapatan);
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_pendidikanterakhir,et_pendidikanterakhir);
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_jeniskelamin,et_jeniskelamin);
        AppUtil.dynamicIconLogoChangeDropdown(getContext(),tf_referensi,et_referensi);
...
//        }
    ...
    public void setDataOnListerner(){
        ...
        DataLengkapPojo d = realm.where(DataLengkapPojo.class).equalTo("idAplikasi", DataLengkapActivityPurna.idAplikasi).findFirst();
...
//            realm.beginTransaction();
            copyRealm.setIdAplikasi(DataLengkapActivityPurna.idAplikasi);
        }
...
//        d.setUid(7983);
        ...
        copyRealm.setCif(DataLengkapActivityPurna.cif);
        copyRealm.setUid(DataLengkapActivityPurna.uid);
        copyRealm.setIdAplikasi(DataLengkapActivityPurna.idAplikasi);
        ...
        copyRealm.setReferensi(Integer.parseInt(val_Referensi));

        realm.insertOrUpdate(copyRealm);
        realm.close();

//        DataLengkapPojo data = realm.where(DataLengkapPojo.class).equalTo("idAplikasi", DataLengkapActivityPurna.idAplikasi).findFirst();
...
//
        tf_tanggallahir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(dataLengkap.getTglLahir().equalsIgnoreCase("22031965")){
                    dataLengkap.setTglLahir(tglLahirOri);
                }
                else{
                    dataLengkap.setTglLahir("22031965");
                }
                hitungUmur();
