...
public class SumPastdueActivity extends AppCompatActivity implements GenericListenerOnSelect, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{
    ...
    private void setData()throws JSONException{
        ...
        Call<ParseResponseArr> call = apiClientAdapter.getApiInterface().listPastdue(req);
            ...
            public void onResponse(Call<ParseResponseArr> call, Response<ParseResponseArr> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().equalsIgnoreCase("00")) {
                        ...
                        sumPastdueAdapter = new SumPastdueAdapter(SumPastdueActivity.this, dataListPastdue);
...
//    }
    ...
    public void customToolbar() {
        ...
        binding.toolbarReguler.tvPageTitle.setText("Laporan Pastdue Gadai");
