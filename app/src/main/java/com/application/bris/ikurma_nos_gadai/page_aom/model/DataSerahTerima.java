...
public class DataSerahTerima {
    ...
    @SerializedName("DisburseRetry")
    @Expose
    private Integer disburseRetry;
    ...
    public Integer getDisburseRetry() {
        return disburseRetry;
    }

    public void setDisburseRetry(Integer disburseRetry) {
        this.disburseRetry = disburseRetry;
    }
}
