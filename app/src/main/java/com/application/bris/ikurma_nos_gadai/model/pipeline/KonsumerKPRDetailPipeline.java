...
public class KonsumerKPRDetailPipeline {
    ...
    @SerializedName("KODE_PROJECT")
    private int kode_project;
    ...
    @SerializedName("JENIS_KPR")
    private String jenis_kpr;
