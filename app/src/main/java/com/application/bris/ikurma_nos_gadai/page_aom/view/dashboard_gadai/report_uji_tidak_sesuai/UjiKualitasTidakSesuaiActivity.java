...
import com.application.bris.ikurma_nos_gadai.databinding.ActivityListTsUjiKualitasBinding;
...
public class UjiKualitasTidakSesuaiActivity extends AppCompatActivity implements GenericListenerOnSelect, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{

    private UjiKualitasTidakSesuaiAdapter ujiKualitasTidakSesuaiAdapter;
    ActivityListTsUjiKualitasBinding binding;
    View view;
    public static SimpleDateFormat dateClient = new SimpleDateFormat("dd-MM-yyyy", Locale.US);
    private List<MGenericModel> dataDropdownTreatment=new ArrayList<>();
    private List<SumTopUpGadai> dataSumUjiKualitas = new ArrayList<>();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //binding View
        binding = ActivityListTsUjiKualitasBinding.inflate(getLayoutInflater());
    ...
    private void loadData(){
        ...
        call.enqueue(new Callback<ParseResponse>() {
                ...
                try {
                    if(response.isSuccessful()){
                        ...
                        if(response.body().getStatus().equalsIgnoreCase("00")){
                            ...
                            AppUtil.notiferror(UjiKualitasTidakSesuaiActivity.this, findViewById(android.R.id.content), response.body().getMessage());
                        }
                    }
                    else{
                        Error error = ParseResponseError.confirmEror(response.errorBody());
                        AppUtil.notiferror(UjiKualitasTidakSesuaiActivity.this, findViewById(android.R.id.content), error.getMessage());
                    }
                }
                catch (Exception e){
                    e.printStackTrace();
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                AppUtil.notiferror(UjiKualitasTidakSesuaiActivity.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
            }
        });
    ...
    private void setData()throws JSONException{
        ...
        Call<ParseResponseGadai> call = apiClientAdapter.getApiInterface().sumUjiKualitasTS(req);
        call.enqueue(new Callback<ParseResponseGadai>() {
            ...
            public void onResponse(Call<ParseResponseGadai> call, Response<ParseResponseGadai> response) {
                ...
                binding.rvListTsUjiKualitas.setVisibility(View.VISIBLE);
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().equalsIgnoreCase("00")) {
                        ...
                        ujiKualitasTidakSesuaiAdapter = new UjiKualitasTidakSesuaiAdapter(UjiKualitasTidakSesuaiActivity.this, dataSumUjiKualitas);
                        binding.rvListTsUjiKualitas.setLayoutManager(new LinearLayoutManager(UjiKualitasTidakSesuaiActivity.this));
                        binding.rvListTsUjiKualitas.setItemAnimator(new DefaultItemAnimator());
                        binding.rvListTsUjiKualitas.setAdapter(ujiKualitasTidakSesuaiAdapter);
            ...
            public void onFailure(Call<ParseResponseGadai> call, Throwable t) {
                binding.loading.progressbarLoading.setVisibility(View.GONE);
                AppUtil.notiferror(UjiKualitasTidakSesuaiActivity.this, findViewById(android.R.id.content), "Terjadi kesalahan");
...
//    }
    ...
    public void initialize(){
        binding.rvListTsUjiKualitas.setVisibility(View.VISIBLE);
        binding.rvListTsUjiKualitas.setHasFixedSize(true);
        ujiKualitasTidakSesuaiAdapter = new UjiKualitasTidakSesuaiAdapter(UjiKualitasTidakSesuaiActivity.this, dataSumUjiKualitas);
        binding.rvListTsUjiKualitas.setLayoutManager(new LinearLayoutManager(UjiKualitasTidakSesuaiActivity.this));
        binding.rvListTsUjiKualitas.setItemAnimator(new DefaultItemAnimator());
        binding.rvListTsUjiKualitas.setAdapter(ujiKualitasTidakSesuaiAdapter);
...
//        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.et_tanggal_uji_kualitas:
                AppUtil.genericCalendarDialog(UjiKualitasTidakSesuaiActivity.this,binding.etTanggalUjiKualitas);
                break;
            case R.id.btn_cari:
                validasi();
                try {
    ...
    private boolean validasi() {
        if (binding.etTanggalUjiKualitas.getText().toString().trim().isEmpty() || binding.etTanggalUjiKualitas.getText().toString().trim().equalsIgnoreCase(" ")) {
            ...
            AppUtil.notiferror(UjiKualitasTidakSesuaiActivity.this, findViewById(android.R.id.content), binding.tfTanggalUjiKualitas.getLabelText() + " " + getString(R.string.title_validate_field));
        }
        return false;
    }
    ...
    public void customToolbar() {
        ...
        binding.toolbarReguler.tvPageTitle.setText("Lapora Tidak Sesuai Uji Kualitas");
